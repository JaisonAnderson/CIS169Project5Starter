    ...
    public static void Initialize(IServiceProvider serviceProvider)
    {
                   ...
                   serviceProvider.GetRequiredService<DbContextOptions<CourseCatalogContext>>()))
        {
            ...
            new Course()
                {
                    Id = 235,
                    CourseName = "Intro to Language",
                    CourseDescription = "Language for Begginers",
                    RoomNumber = 210,
                    StartTime = new TimeOnly(),
                    EndTIme = new TimeOnly()
                ...
                {
                    Id = 235,
                    CourseName = "Intro to spanish",
                    CourseDescription = "sspanish for Begginers",
                    RoomNumber = 212,
                    StartTime = new TimeOnly(),
                    EndTIme = new TimeOnly()
                ...
                new Course()
                {
                    ...
                    CourseDescription = "computers for Begginers",
                    RoomNumber = 212,
                    StartTime = new TimeOnly(),
                    EndTIme = new TimeOnly()
